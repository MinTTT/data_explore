...
#%%
od_df = pd.read_csv(r'./20200318/20200318_ratio_od.csv', na_values='####')
cyto_df = pd.read_csv(r'./20200318/20200318_ratio_cyto.csv', na_values='####')
#%%
od_df.index = od_df['ID']
cyto_df.index = cyto_df['ID']
data_raw = pd.concat([od_df, cyto_df], axis=1)
data_raw = data_raw.drop(data_raw.columns[4], axis=1)
data_raw = data_raw.drop(['#80-2'], axis=0)
#%%
...
data_raw['GFP_ratio'] = data_raw['GFP_ratio'] / (data_raw['GFP_ratio'] + data_raw['mCherry_ratio'])
data_raw['mCherry_ratio'] = 1. - data_raw['GFP_ratio']

data_raw.to_csv(r'./20200318/20200318_ratio_sum.csv')
#%%
