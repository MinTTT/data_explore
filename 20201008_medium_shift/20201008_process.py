...
# %% set data dir
data_raw_path = r'./20201008_medium_shift/20201008_medium_shift.csv'
fcs_dir = r'Z:\panchu\experiment_data\cytometry\Exp_20201008_1'
flowcyto_stat = pd.read_csv(r'./20201008_medium_shift/20201008_medium_shift_cyto.csv', skiprows=2,
                            na_values='####')
...
for samp in sample_list:
    ...
    ani.save(f'./20201008_medium_shift/animation_{samp}.avi', writer='ffmpeg', fps=4)
# fig4.show()
